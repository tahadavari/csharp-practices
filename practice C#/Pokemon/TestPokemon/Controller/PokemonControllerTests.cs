...
namespace TestPokemon.Controller
{
    public class PokemonControllerTests
    {
        ...
        public void PokemonController_CreatePokemon_ReturnOK()
        {
            ...
            int ownerId = 1;
            int catId = 2;
            var pokemonMap = A.Fake<Pokemon.Models.Pokemon>();
            var pokemon = A.Fake<Pokemon.Models.Pokemon>();
            ...
            A.CallTo(() => _mapper.Map<Pokemon.Models.Pokemon>(pokemonCreate)).Returns(pokemon);
